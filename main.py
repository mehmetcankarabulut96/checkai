...
ANALYSIS_MAP = {
    "DEEPFAKE": {
        ...
        "action": "REJECT",
        "risk_level": "HIGH",
        "description": "Face manipulation or swap detected in the image.",
        "recommendation": "Reject this image for identity verification."
    },
    "SYNTHETIC": {
        "label": "SYNTHETIC_CONTENT",
        "action": "REJECT",
        "risk_level": "HIGH",
        "description": "Image is entirely generated by artificial intelligence.",
        "recommendation": "Restrict access as this profile photo is likely synthetic."
    },
    "MODIFIED": {
        "label": "MODIFIED_CONTENT",
        "action": "REVIEW",
        "risk_level": "MEDIUM",
        "description": "Heavy digital retouching or filters detected.",
        "recommendation": "Manual verification is recommended for this asset."
    },
    "INCONCLUSIVE": {
        "label": "INCONCLUSIVE",
        "action": "REVIEW",
        "risk_level": "MEDIUM",
        "description": "Analysis is uncertain due to low quality or screenshot artifacts.",
        "recommendation": "Request a fresh, camera-taken photo from the user."
    },
    "AUTHENTIC": {
        "label": "AUTHENTIC",
        "action": "ACCEPT",
        "risk_level": "LOW",
        "description": "Image appears to be original and unmanipulated.",
        "recommendation": "Safe to proceed with the current asset."
    }
}
